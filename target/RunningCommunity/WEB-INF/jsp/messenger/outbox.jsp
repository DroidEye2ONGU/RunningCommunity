...
<head>
    ...
    <script type="text/javascript">
        function delMessage() {
            ...
            document.forms.outboxForm.action = "/message/deleteSenderMessage";
    ...
    <div id="main">
        ...
        <div id="tabs1">
            <ul>
                ...
                <li><a href="/member/toSendMessagePage" title="发件箱"><span><b>发件箱</b></span></a></li>
            </ul>
        </div>
        <br/><br/>
                        ...
                        <tr>
                            ...
                            <td width="100%" colspan="2">
                                <table width="100%">
                                    ...
                                    <c:forEach items="${requestScope.sendedMessages}" var="message">
                                        <tr>
                                            <td width="10%">
                                            ...
                                            <td width="20%">
                                                <a href="/message/seeMessageDetail?messageId=${message.id}">
                                                        ${message.title}
                                                </a>
                                            </td>
                                            <td width="20%">${message.receiver}</td>
                                            <td width="30%">
                                                <fmt:formatDate
